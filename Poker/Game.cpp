...
void Game::draw()
{
	...
	glVertexPointer(2, GL_FLOAT, 0, cardVertexArray); //резирвирует вершины дл€ 4-х точек
	glTexCoordPointer(2, GL_FLOAT, 0, cardTextureArray); //резирвирует текстуру дл€ выводимой фигуры
	glDrawElements(GL_QUADS, 4, GL_UNSIGNED_BYTE, cardIndexArray); //задает пор€док соединени€ вершин
